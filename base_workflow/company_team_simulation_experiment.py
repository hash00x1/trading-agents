...
# Define the workflow state, try to set in researcher team to be in the same state and successfully run
...
workflow.add_edge("market_analyst", "bearish_researcher")
