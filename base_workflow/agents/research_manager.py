...
class ResearchManager(DialogueSimulatorAgent):
    ...
    """
    def __init__(self, research_agents: List[DialogueAgent], rounds) -> None:
...
research_manager = ResearchManager(research_agents=[bullish_researcher, bearish_researcher], rounds=6)       
